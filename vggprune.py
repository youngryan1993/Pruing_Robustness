...
origin_num_parameters = sum([param.nelement() for param in origin_model.parameters()])
num_parameters = sum([param.nelement() for param in newmodel.parameters()])
param_reduction_percent = ((origin_num_parameters-num_parameters)/origin_num_parameters)*100
